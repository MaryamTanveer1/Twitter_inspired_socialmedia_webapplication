<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Friends.aspx.cs" Inherits="WebApplication34.Friends" %>
    ...
    <form id="form2" runat="server">
        <div class="friends">
            <asp:Repeater ID="rptFriends" runat="server">
                <ItemTemplate>
                    <p>
                        <img src="images.jpeg" alt="" style="width: 2vw; height: 5vh; margin-left: 5em;" class="rounded-circle" />

                        <asp:Label ID="lblFriendName" runat="server" Text='<%# Eval("name") %>' Class="flabel"></asp:Label>
                     
                        <asp:Button ID="btnDelete" runat="server" Text="Remove Friend" OnClick="Button_Click" CommandArgument='<%# Eval("frndid") %>' Class="delbtn" />
                    </p>
                </ItemTemplate>
            </asp:Repeater>
        </div>
